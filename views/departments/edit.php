...
$id = htmlspecialchars($this->department->id);
$code = htmlspecialchars($this->department->code);
$name = htmlspecialchars($this->department->name);
$manager = htmlspecialchars($this->department->manager_name ?? '');

echo <<<HTML
<main class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="m-0 font-weight-bold text-dark">Chỉnh sửa Bộ phận</h4>
...
echo <<<HTML
            <form action="index.php?controller=department&action=edit&id={$id}" method="POST">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="manager_name" name="manager_name" value="{$manager}">
                    </div>
                </div>
                <div class="mt-4">
